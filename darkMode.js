...
// Set Header Color
document.querySelectorAll("h1, h3, h4, h5, h6, .internal-link, .nav-link, .lesson-navigation__link, .course-card-header__title, .viking-advert__brand-name, .viking-advert__pitch, .footer-link").forEach( (el) => {
